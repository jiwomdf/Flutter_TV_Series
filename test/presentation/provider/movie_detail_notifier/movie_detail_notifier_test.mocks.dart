...
// in flutter_tv_series/test/presentation/provider/movie_detail_notifier/movie_detail_notifier_test.dart.
...
import 'package:flutter_tv_series/common/failure.dart' as _i6;
import 'package:flutter_tv_series/domain/entities/movie.dart' as _i9;
import 'package:flutter_tv_series/domain/entities/movie_detail.dart' as _i7;
...
class MockMovieDetailUseCase extends _i1.Mock
    implements _i4.MovieDetailUseCase {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i7.MovieDetail>> getMovieDetail(
          int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #getMovieDetail,
...
/// A class which mocks [MovieRecommendationsUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockMovieRecommendationsUseCase extends _i1.Mock
    implements _i8.MovieRecommendationsUseCase {
  MockMovieRecommendationsUseCase() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i9.Movie>>> getMovieRecommendations(
          dynamic id) =>
      (super.noSuchMethod(
        Invocation.method(
...
/// A class which mocks [WatchListStatusUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockWatchListStatusUseCase extends _i1.Mock
    implements _i10.WatchListStatusUseCase {
  MockWatchListStatusUseCase() {
    _i1.throwOnMissingStub(this);
  }
